...
void bob_arenda(const int month)
{
    bob.account -= bob.arenda.month_pay;
...
void bob_init()
{
    ...
    bob.arenda.platez = 25000;
    bob.arenda.credit = 0;
    bob.arenda.rate = 0.10;
    bob.arenda.month_pay = 25000;  
    bob.account -= bob.arenda.platez;
